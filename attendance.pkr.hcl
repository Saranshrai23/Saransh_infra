...
variable "postgres_password" {
  type        = string
  description = "Development-only local PostgreSQL password baked into config.yaml."
  default     = "password"
  sensitive   = true
}
...
source "amazon-ebs" "attendance" {
  ...
  ami_description = "OTMS Attendance API AMI with Python 3.11, Poetry, Gunicorn, PostgreSQL, Redis and Liquibase"
